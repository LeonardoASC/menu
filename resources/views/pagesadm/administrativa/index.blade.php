                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
                    <div
                        ...
                        <div class="text-right">
                            <p class="text-2xl">{{ $somaValores }} R$</p>
                            <p>Total de vendas</p>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="text-right">
                            <p class="text-2xl">{{ $mesasOcupadas }}</p>
                            <p>Mesas ativas</p>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="text-right">
                            <p class="text-2xl">{{ $comandaAberta }}</p>
                            <p>Comandas Ativas</p>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="text-right">
                            <p class="text-2xl">{{ $nomeProdutoMaisComum }}</p>
                            <p>Pedido mais realizado</p>
                        </div>
                    </div>
                </div>
                <!-- ./Statistics Cards -->
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 p-4 gap-4 ">
                        ...
                        <div class="rounded-t mb-0 px-0 border-0">
                            ...
                            <div class="overflow-x-auto ">
                                <table class="items-center w-full">
                                    ...
                                    <tbody class="w-full h-20 overflow-y-scroll">
                                        ...
                                        @else
                                            @foreach ($clientesAtivos as $clienteAtivo)
                                                <tr class="text-gray-700 dark:text-gray-100 ">
                                                    ...
                                                    <td
                                                        class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                        {{ $clienteAtivo->pedidos->where('status', 'Solicitado')->count() }}
                                                    </td>
                                                    <td
                                                        class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                        {{ $clienteAtivo->pedidos->where('status', 'Entregue')->count() }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif
                    ...
                    <div
                        ...
                        <div class="rounded-t mb-0 px-0 border-0">
                            <div class="flex flex-wrap items-center px-4 py-2">
                                <div class="relative w-full max-w-full flex-grow flex-1">
                                    <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">Atividades
                                        Recentes</h3>
                                </div>
                                <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                                    <button
                                        class="bg-blue-500 dark:bg-gray-100 text-white active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                        type="button">Veja todas</button>
                                </div>
                            </div>
