            ...
            <div class="rounded-t mb-0 px-0 border-0">
                <div class="flex flex-wrap items-center px-4 py-2 justify-center">
                    <div class=" w-full max-w-full flex-grow flex justify-between">
                        <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50 flex items-center">Clientes
                            Ativos</h3>
                                    ...
                                    <tr class="text-gray-700  dark:text-gray-100 ">
                                        ...
                                        <td
                                            ...
                                            <form action="{{ route('usuario.destroy', $usuario->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button class="text-gray-700 border p-2 rounded-lg hover:bg-slate-200 dark:text-white"
