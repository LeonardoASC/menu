<div class="min-h-screen flex flex-col justify-between">
    <div class="bg-white text-black py-[3%] fixed bottom-0 left-0 w-full border-t-2 border-gray-300 rounded-t-2xl drop-shadow-2xl flex justify-around items-center">
