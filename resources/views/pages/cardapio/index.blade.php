...
<body>
                        ...
                        <table class="min-w-full leading-normal ">
                            ...
                            @else
                                @foreach ($produtos as $produto)
                                    ...
                                    <tbody>
                                        <tr onclick="submitForm({{ $produto->id }})" class="cursor-pointer">
                                            <td class="py-2">
                                                <div class="flex items-center">
    ...
    <div class="mb-20 w-full flex justify-center">
        <button id="scrollToTop" class="h-10 border rounded-xl p-2 bg-yellow-500">
            Ir para o Topo
        </button>
    </div>
    <x-rodape />
