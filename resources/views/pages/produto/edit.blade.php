    ...
    <div class="flex flex-col justify-center items-center h-screen bg-white">
        ...
        <form action="{{ route('produto.update', ['produto' => $produto->id]) }}" method="post">
            ...
            <div class="my-4 flex flex-col p-5 items-center">
                ...
                <p>Categoria</p>
                <input type="text" name="categoria_id" value="{{ $produto->categoria_id ?? old('categoria_id') }}"
                    placeholder="" class="rounded mb-2 border" />
                <p class="text-xs  text-gray-500">
                ...
                <p>Preço</p>
                <input type="text" name="preco" value="{{ $produto->preco ?? old('preco') }}"
                    placeholder="" class="rounded mb-2 border" />
                <p class="text-xs  text-gray-500">
                ...
                <p>Imagem</p>
                <input type="text" name="imagem" value="{{ $produto->imagem ?? old('imagem') }}"
                    placeholder="" class="rounded mb-2 border" />
                <p class="text-xs  text-gray-500">
